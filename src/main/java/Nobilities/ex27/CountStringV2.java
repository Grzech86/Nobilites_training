package Nobilities.ex27;

import java.util.HashMap;
import java.util.Map;

public class CountStringV2 {

    public static Map<String, Integer> stringCounter(String[] input) {
        ...
        for (String line : input) {
            ...
            for (String element : elements) {
                int frequency = (mapOfWords.containsKey(element) ? mapOfWords.get(element) + 1 : 1);

                mapOfWords.put(element, frequency);
            }
        }
        return mapOfWords;
    }
    ...
    public static void main(String[] args) {
        ...
        var howMany = stringCounter(input);
