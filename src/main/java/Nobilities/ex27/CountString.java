...
//Zadanie 26: Implement algorithm counting words taking as input collection of strings
public class CountString {


    public static Integer stringCounter(String[] input) {
        int counter = 0;
    ...
    public static void main(String[] args) {
        ...
        int howMany = stringCounter(input);
