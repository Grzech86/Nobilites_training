package Nobilities.ex29;//package Nobilities.ex29;
//
//public class LottoV4 {
//
//    public static void countLotto2(Lotto lotto) {
...
//    Integer num();
//
//    Integer countLotto2(Integer[] input, int k);
//}
//
// class k implements Lotto {
//    public final int k;
//
//    k(int k) {
//        this.k = k;}
...
//
//     @Override
//    public Integer countLotto2(Integer[] input, int k) {
//
//        int counter = 0;
//
//        for (final var line : input) {
//            if (containsNumber(line),k) {
//                counter++;
//            }
//        }
//
//        return counter;
//    }
//    public boolean containsNumber (String line,int k){
